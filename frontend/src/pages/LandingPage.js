      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-4" style={{ fontFamily: 'Outfit, sans-serif' }}>
              Everything You Need
            </h2>
            <p className="text-lg text-stone-500 max-w-2xl mx-auto" style={{ fontFamily: 'Manrope, sans-serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold tracking-tight text-slate-900 mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>Smart Scheduling</h3>
                  <p className="text-base leading-relaxed text-stone-500" style={{ fontFamily: 'Manrope, sans-serif' }}>
            ...
            >
              ...
              <h3 className="text-2xl font-semibold tracking-tight text-slate-900 mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>Google Meet</h3>
              <p className="text-base leading-relaxed text-stone-500" style={{ fontFamily: 'Manrope, sans-serif' }}>
            ...
            >
              ...
              <h3 className="text-2xl font-semibold tracking-tight text-slate-900 mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>Role Management</h3>
              <p className="text-base leading-relaxed text-stone-500" style={{ fontFamily: 'Manrope, sans-serif' }}>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold tracking-tight text-slate-900 mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>Video Library</h3>
                  <p className="text-base leading-relaxed text-stone-500" style={{ fontFamily: 'Manrope, sans-serif' }}>
      ...
      <section className="py-20 bg-orange-600">
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-4" style={{ fontFamily: 'Outfit, sans-serif' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="text-xl font-bold" style={{ fontFamily: 'Outfit, sans-serif' }}>ClassHub</span>
            </div>
            <p className="text-stone-400 text-sm" style={{ fontFamily: 'Manrope, sans-serif' }}>
